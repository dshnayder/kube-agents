...
| `bench/experiments/timesfm-backtest/RESULTS.md` | Experiment record | Go/no-go reading of the TimesFM backtest for stakeholders: whether day-ahead forecasts can drive threshold warnings. | Warning precision and recall, new crossings, the −10%/+5% accuracy band, recommendation | Experiment record; the design document links it |
