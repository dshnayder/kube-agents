...
| `experiments/capability-scope-ab/README.md` | Experiment | Method and code for the capability-scoping A/B behind `docs/designs/context-scoped-capabilities.md`: arms, rungs, probes, metrics, how to rerun it. | Arms, rungs, `scenarios.json`, `run_matrix.sh`, `analyze.py`, limits | Experiment record; results live in the design document |
| `experiments/capability-scope-ab/results/gemini-3.1-pro.md` | Experiment record | Scored table and arm comparisons for the capability-scoping A/B on Gemini 3.1 Pro, written by `make_results.sh`. | Selection, cost, intervals, p-values | Generated; do not hand-edit |
| `experiments/capability-scope-ab/results/gemini-3.5-flash.md` | Experiment record | The same tables for the Gemini 3.5 Flash repeat. | Selection, cost, intervals, p-values | Generated; do not hand-edit |
